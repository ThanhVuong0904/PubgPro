...
export default function PlayerStats() {
  ...
  const latestMatch = matchesData && matchesData.length > 0 ? matchesData[0] : null;

  return (
    <>
      <div className="mb-8">
        <PlayerSearch onSearchSuccess={handleSearchSuccess} defaultPlayer={playerName} defaultPlatform={platform} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {matchesData && <MatchHistory matches={matchesData} />}
        </div>
      </div>
    </>
  );
